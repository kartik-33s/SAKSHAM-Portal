...
export function PlayStoreButton({
  ...
  return (
    <Button className={cn("h-11 gap-2 bg-black hover:bg-zinc-900 text-white border border-white/20", className)} {...props}>
      <PlayStoreIcon className="size-5" />
      <div className="text-left flex flex-col items-start justify-center pr-2">
        <span className="text-[10px] leading-none font-light tracking-tighter text-zinc-300">
          GET IT ON
        </span>
